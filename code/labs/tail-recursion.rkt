...
#|
You may recall that in the past, you wrote a procedure, `tally-symbols`,
that took as input a list of mixed values (both symbols and other typs
of values) and returned a count of the number of symbols in the list.
...
#|
d. Update the helper for `tally-symbols` to print out calls, and
