...
The `csc151` library, which we designed for this course, provides a
...
## Composition, sectioning, and mapping
...
You can also create anonymous procedures in other ways.  You've seen
