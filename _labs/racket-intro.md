---
title: An introduction to Racket and DrRacket
summary: |
...
If you haven't already, you should download and install DrRacket on your own machine:
...
To help you manage the work between yourself and your partner, the lab instructions will specify how you should work with your partner for each exercise, either in an *individual* capacity or *collaborative* capacity.

+   When working individually on an exercise, please wait for your partner to finish the current exercise and once both of you are done, please check your work with each other before proceeding.
...
Each problem also has an *estimated* time limit that you should try to aim for with the problem.
If you begin to exceed this estimated time for a problem, post a note in the chat for your lab group and one of the course staff will stop by to visit.

When working collaboratively with your partner, follow this protocol:

+   One person should volunteer to share their screen.
    They will host the DrRacket instance and be responsible for entering in code.
+   The other person will primarily drive what should be typed into DrRacket.
    They will also be responsible for setting a timer to know how much time has been spent on the current problem.
...
(Spend 5 minutes **individually** on this exercise and check your answers with your partner after you are both done.)
...
(Spend 5 minutes **individually** on this exercise.)
...
(Spend 5 minutes discussing the answer to this exercise **collaboratively** with your partner.)
...
(Spend 5 minutes working through the parts of this exercise **individually**.
When a part asks you to discuss your results with your partner, do so.)
...
8.  Congratulations, you've (should have successfully) computed the average trial score!
    If not, review the error and try to fix it on your own with your partner's help.
    If you get stuck, hail down an instructor!
...
(Replace `PM` with your own name for the proper effect.)
...
Note how this definition acts as shorthand: where ever `name` appears in the code, the string `"PM"` is substituted instead.
We'll discuss these definitions---which define *variables*---in detail next week!

### Exercise 7: Image definitions

(Spend 5 minutes working through this exercise **individually**.)
...
2.  In the definitions pane, write definitions for `blue-circle`, a solid circle of radius 10, `red-square`, a solid red square of edge-length 20, and `black-rectangle`, an outlined black rectangle of width 30 and height 10.
    ...
    (require 2htdp/image)
    ; shapes.rkt
    ; A file from the first lab for CSC-151-01 2021 Spring Term One
    ; Authors: One Name
    ;          Another Name
    ; Acknowledgements:
    ;   Any help you got
...
(Spend 5 minutes working through this exercise **collaboratively**.)

1. Compare your definitions of `blue-circle`, `red-square`, and
`black-rectangle`.

2. Define a simple image (which you define as `image` using `define) by combining those three basic shapes with `above` and `beside`.
...
(Spend 5 minutes discussing your responses to the exercise **collaboratively**.)
...
One member of your group should turn in their `shapes.rkt` file to Gradescope under the appropriate lab assignment.
